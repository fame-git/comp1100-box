...
public class BTree<T extends Comparable<T>> {
    ...
    private void split(BTreeNode node, BTreeNode childToSplit) {
        ...
        // Get median key
        int med = (childToSplit.keys.size() - 1) / 2;
    ...
    class BTreeNode {
         ...
         * @return
         */
        private BTreeNode insert(T key) {
            /*
                Task 1.
            ...
            if (this.children.size() == 0) {
                ...
                } else if (key.compareTo(this.keys.get(keys.size() - 1)) > 0) {
